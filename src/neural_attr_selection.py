...
def main():
    ...
    for i in TOP_SELECTED_FEATURES:
        ...
        #Genreate list of indicies from 0 to number of features. This is used when seperating the arff file into X and Y
        ...
        weka.arff_to_csv(f'{DATA_DIR}/neural/arff/x/x_train_gr_smpl_top_{i}.arff', Path(f'{DATA_DIR}/neural/csv/x/x_train_gr_smpl_top_{i}.csv'))
        ...
        weka.arff_to_csv(f'{DATA_DIR}/neural/arff/y/y_train_smpl_top_{i}.arff', Path(f'{DATA_DIR}/neural/csv/y/y_train_smpl_top_{i}.csv'))
        ...
        weka.arff_to_csv(f'{DATA_DIR}/neural/arff/x/x_test_gr_smpl_top_{i}.arff', Path(f'{DATA_DIR}/neural/csv/x/x_test_gr_smpl_top_{i}.csv'))

        #Export class simply incase input data is non-standard y data points (e.g. has been randomised)
        weka.filter_attributes(test_input_path, f'{DATA_DIR}/neural/arff/y/y_test_smpl_top_{i}.arff', [2304])
        weka.arff_to_csv(f'{DATA_DIR}/neural/arff/y/y_test_smpl_top_{i}.arff', Path(f'{DATA_DIR}/neural/csv/y/y_test_smpl_top_{i}.csv'))
